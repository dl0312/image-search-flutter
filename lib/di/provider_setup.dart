...
List<SingleChildWidget> dependentModels = [
  ProxyProvider<http.Client, PixabayApi>(update: (context, client, api) {
    return PixabayApi(client);
  }),
  ProxyProvider<PixabayApi, PhotoApiRepository>(update: (context, api, _) {
...
List<SingleChildWidget> viewModels = [
  ChangeNotifierProvider<HomeViewModel>(create: (context) {
